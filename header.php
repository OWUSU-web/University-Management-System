...
<html class="no-js" lang="">
    <head>
        ...
        <meta name="author" content="CHARRLES OWUSU ASARE>
    ...
    <body>
        ...
        <header class="container header_area fix" style="background-color: #002366"> <!-- Changed color to deep blue -->
            <div id="sticker" style="background-color: #002366"> <!-- Changed color to deep blue -->
                <div class="head">
        ...
        <div class="maincontent container fix">
            <div id="stickerside" style="background-color: #002366"> <!-- Changed color to deep blue -->
                <div class="sidebar fix" style="background-color: #002366"> <!-- Changed color to deep blue -->
